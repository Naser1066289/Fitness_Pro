...
// new impl
        ...
        ArrayAdapter<CharSequence> adapterConsumed = ArrayAdapter.createFromResource(
                this, R.array.time_periods_consumed, android.R.layout.simple_spinner_item);
        adapterConsumed.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerTimePeriodConsumed.setAdapter(adapterConsumed);

        spinnerTimePeriodConsumed.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                updateChartConsumed(position);
            }
